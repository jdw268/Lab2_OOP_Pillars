...
* Class: CIT-244
* Date:  9.18.17
* Description: This class is the Minivan class that extends the Vehicle class
* It's used to create a Minivan object.
*/
import java.io.*;
import java.util.*;
...
public class Minivan extends Vehicle{
	...
	public Minivan(String makeInput, FileReader configInput, String pidNumber){

		//set inherited data with super
		super(makeInput, configInput, pidNumber);

		//use getSeats to call setEngine
		setSeats(getSeats());
	...
	public Minivan(String makeInput, String modelInput, FileReader configInput, int seatsInput){
		//set inherited data with super
		super(makeInput, modelInput, configInput);

		//set data for Minivan
		setSeats(seatsInput);
	}
	...
	public int getSeats(){
		...
		//search customOption in config file for:  search from Minivan and 5 indexes of list
		//find index of "Minivan" first
		while(continueRead){
			...
			if (line.equalsIgnoreCase("Minivan")) {
				continueRead = false;
			}
	...
	*/
	public String readModelName(){
		...
		//search the name for substring "Minivan" and add 5 for other options
		position = modelName.indexOf("MiniVan") + 7;
